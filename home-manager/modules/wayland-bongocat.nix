{unstablePkgs, ...}: {
  ...
  xdg.configFile."bongocat/config".text = ''
    ...
    # Size settings
    cat_height=180 # Height of bongo cat (10-200)
    ...
    overlay_height=160 # Height of the entire overlay bar (20-300)

    overlay_opacity=20              # Background opacity (0-255)
    overlay_position=bottom             # Position on screen (top/bottom)
    layer=overlay                        # Layer type (top/overlay)
